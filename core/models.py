...
STANDARD_COA = [
    ...
    ("1120","Other Debtors / Accrued Income",       "Asset",    "Debit",  "No",      None,  0),
    ("1130","Stock / Inventory",                    "Asset",    "Debit",  "No",      None,  0),
    ...
    ("1320","Fixed Assets — Fixtures & Fittings",   "Asset",    "Debit",  "No",      None,  0),
    ("1330","Fixed Assets — Leasehold Improvements","Asset",    "Debit",  "No",      None,  0),
    ("1340","Intangible Assets",                    "Asset",    "Debit",  "No",      None,  0),
    ...
    ("2210","Pension Payable",           "Liability","Credit", "No",      None,  0),
    ...
    ("2510","HP / Finance Lease Liability","Liability","Credit","No",     None,  0),
    ("2600","Accruals",                  "Liability","Credit", "No",      None,  0),
    ("2610","Deferred Income",           "Liability","Credit", "No",      None,  0),
    ...
    ("5545","Office Supplies & Stationery","Overhead","Debit",  "Yes",     20.0,  0),
    ("5550","Marketing and Advertising",  "Overhead", "Debit",  "Yes",     20.0,  0),
    ("5555","Postage & Couriers",          "Overhead", "Debit",  "Yes",     20.0,  0),
    ("5560","Travel and Accommodation",   "Overhead", "Debit",  "Yes",     20.0,  0),
    ("5565","Cleaning and Laundry",        "Overhead", "Debit",  "Yes",     20.0,  0),
    ("5570","Meals and Entertainment",    "Overhead", "Debit",  "Yes",     20.0,  0),
    ("5575","Client Entertainment",       "Overhead", "Debit",  "Yes",     20.0,  0),
    ("5576","Staff Training & Development","Overhead","Debit",  "Yes",     20.0,  0),
    ("5577","Staff Welfare & Social Events","Overhead","Debit", "Yes",     20.0,  0),
    ("5580","Motor Expenses",             "Overhead", "Debit",  "Yes",     20.0,  0),
    ("5585","General Maintenance",        "Overhead", "Debit",  "Yes",     20.0,  0),
    ("5586","Equipment Hire / Leasing",   "Overhead", "Debit",  "Yes",     20.0,  0),
    ("5590","Professional Fees",          "Overhead", "Debit",  "Yes",     20.0,  0),
    ("5592","Subsistence",                "Overhead", "Debit",  "Yes",     20.0,  0),
    ...
    ("5615","Amortisation",              "Overhead", "Debit",  "No",      None,  0),
...
class ImportModel:
    ...
    def stage_transactions(entity_id: str, batch_id: str, rows: list) -> int:
        ...
        for row in rows:
            ...
            # Skip if already staged for this entity
            existing = db.fetchone(
